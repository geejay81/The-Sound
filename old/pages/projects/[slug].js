    ...
    <Layout>
      ...
      <article className="px-6 md:px-0">
        <header>
          ...
          {frontMatter.url && (
            <div className='my-5'>
              <Link href={frontMatter.url} className='mb-4'>
                <a className="bg-purple-800 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Visit</a>
              </Link>
            </div>
          )}
        </header>
